...
public class TetheringConfiguration {
    ...
    public TetheringConfiguration(@NonNull Context ctx, @NonNull SharedLog log, int id,
        ...
        // TODO Tethering is still needed by WIGIG framework (SoftAP) in Android T+
        tetherableWigigRegexs = getResourceStringArray(
                res, R.array.config_tether_wigig_regexs);
